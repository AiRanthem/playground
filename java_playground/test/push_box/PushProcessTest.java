...
class PushProcessTest {
    ...
    void searchAllOperations() {
        PushProcess process = new PushProcess(bh3Map, bh3MaxHeight, bh3MaxWidth, bh3HeroX, bh3HeroY, bh3Targets, null);
    ...
    void testPerformOperation() {
        PushProcess oldProcess = new PushProcess(bh3Map, bh3MaxHeight, bh3MaxWidth, bh3HeroX, bh3HeroY, bh3Targets, null);
    ...
    @Test
    void testHash() {
        PushProcess process1 = new PushProcess(bh3Map, bh3MaxHeight, bh3MaxWidth, bh3HeroX, bh3HeroY, bh3Targets, null);
        PushProcess process2 = new PushProcess(bh3Map, bh3MaxHeight, bh3MaxWidth, bh3HeroX, bh3HeroY, bh3Targets, null);
